    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'channel', 'middleware' => 'role:super-admin|user', 'as' => 'channel.'], function () {
            ...
            Route::get('/{slug}', function(){
                return view('website.channel.group_stream.home');
            })->name('landing');
        ...
        Route::group(['prefix' => 'admin', 'middleware' => 'role:admin|super-admin', 'as' => 'admin.'], function () {
            ...
            Route::group(['prefix' => 'manage', 'as' => 'manage.'], function () {
                ...
                //GIZE_CHANNELS
                Route::group(['prefix' => 'gize_channels', 'as' => 'gize_channels.'], function () {
                    //Get All
                    Route::get('/', [GizeChannelController::class, 'index'])->name('index'); //->middleware(['auth:web', 'scope:read-ebook']);
                    //add
                    Route::post('/add', [GizeChannelController::class, 'addGizeChannel'])->name('add');
                    //update
                    Route::post('/update', [GizeChannelController::class, 'updateGizeChannel'])->name('update');
                    //get
                    Route::get('/{id}', [GizeChannelController::class, 'getGizeChannelById'])->name('get');
                    //delete
                    Route::delete('/{id}', [GizeChannelController::class, 'deleteGizeChannel'])->name('delete');
                    //delete selected
                    Route::delete('/del-selected', [GizeChannelController::class, 'deleteCheckedGizeChannels'])->name('deleteSelected');
                    //check slug
                    Route::get('/check_slug', [GizeChannelController::class, 'checkSlug'])->name('checkslug');
                });
