                                    ...
                                    <td id="{{ $gize_channel->id }}">
                                        <div class="row">
                                            ...
                                            <button class="mx-1 btn btn-xs btn-edit btn-outline-info" data-toggle="modal"
                                                ...
                                                data-slug="{{ $gize_channel->slug }}" title="Edit Gize Channel"><i
...
@section('js')
    ...
    <script>
        $(function() {
            ...
            $('.select-channel-admins').select2({
                theme: 'bootstrap4',
                dropdownParent: $('#gize_channelModal')
            });
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            url =
                "{{ route('admin.manage.gize_channels.delete', ['id' => ':id', 'language' => app()->getLocale()]) }}";
