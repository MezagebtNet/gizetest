<a class="collection-card channel-card-link" href="{{ route('channel.col.details.index', ['slug'=>$channel->slug, 'col_slug'=>$collection->slug]) }}">
    <div class="mx-2">
        ...
        <div class="card card-widget widget-user-2 shadow-sm" style="border: solid 1px gray;">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header">
              <div class="widget-user-image">
                <img class="" src="{{ isset($collection->poster_image_url) && $collection->poster_image_url!=null && $collection->poster_image_url!=null ? asset('storage/'.$collection->poster_image_url) : asset('storage/images/c/channelvideo.png') }}" alt="">
              </div>
              <!-- /.widget-user-image -->
